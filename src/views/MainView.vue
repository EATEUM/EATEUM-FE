...
// 1. 데이터 소스 (사용자님의 기존 Mock 데이터 및 UI 관련 설정 수정 금지)
const responseData = {
  success: true,
  message: '성공',
  data: {
